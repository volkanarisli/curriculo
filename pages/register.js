...
const Register = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center">
            <label>
                First Name
                <input className="border border-indigo-600" type="text" name="firstName" onChange={e => onInputChange({ key: e.target.name, value: e.target.value })} />

            </label>
            <label>
                Last Name
                <input className="border border-indigo-600" type="text" name="lastName" onChange={e => onInputChange({ key: e.target.name, value: e.target.value })} />
